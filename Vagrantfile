...
Vagrant.configure(VAGRANT_API_VERSION) do |config|
  ...
  config.vm.define :ansiblepackeriotest do |d|

    d.vm.hostname = 'ansiblepackeriotest'
    ...
    d.vm.provider :virtualbox do |v|
      ...
      v.customize [ 'modifyvm', :id, '--name', 'ansiblepackeriotest', '--memory', '512', '--cpus', '1' ]
    end
